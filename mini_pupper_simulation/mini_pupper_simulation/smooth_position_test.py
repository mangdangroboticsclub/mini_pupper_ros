...
class SmoothPositionTest(Node):
    ...
    def update_running_gait(self):
        ...
        # Running gait parameters
        stride_height = 0.4  # How high legs lift
        stride_forward = 0.3  # How much legs extend forward/back
        ...
        if int(self.time_elapsed) % 5 == 0 and int(self.time_elapsed * 20) % 100 == 0:
            ...
            self.get_logger().info(f'🏃‍♂️ Running gait active - {remaining}s remaining (Phase: {gait_phase:.2f})')
