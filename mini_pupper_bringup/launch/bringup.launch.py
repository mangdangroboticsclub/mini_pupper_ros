...
def generate_launch_description():
    ...
    servo_interface_launch_path = PathJoinSubstitution(
        [FindPackageShare('mini_pupper_driver'), 'launch',
         'servo_interface.launch.py']
    )

    vel_to_servo_controller_launch_path = PathJoinSubstitution(
        [FindPackageShare('mini_pupper_control'), 'launch',
         'vel_to_servo_controller.launch.py']
    )
    ...
    vel_to_servo_controller = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(vel_to_servo_controller_launch_path),
        condition=IfCondition(joint_hardware_connected),
    )
