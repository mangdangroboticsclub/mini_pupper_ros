import os
import sys
sys.path.append("/home/ubuntu/ros2_ws/src/mini_pupper_ros/mini_pupper_control/mini_pupper_control")
sys.path.extend([os.path.join(root, name) for root, dirs, _ in os.walk("/home/ubuntu/ros2_ws/src/mini_pupper_ros/mini_pupper_control/mini_pupper_control") for name in dirs])
