...
**Don't run this command while using move_base because when you are doing nothing with the joystick, it would still set all the values in cmd_vel to zero.**
```sh
