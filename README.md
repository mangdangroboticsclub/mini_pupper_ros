[![ROS2 VERSION](https://img.shields.io/badge/ROS-ROS%202%20Jazzy-brightgreen)](https://docs.ros.org/en/jazzy/index.html)
&nbsp;
...
### Pre-built Images
Flash a ready-to-use image containing Ubuntu, ROS 2, and all Mini Pupper packages. The current source tree targets Ubuntu 24.04 with ROS 2 Jazzy; the older Humble images remain listed for users who still need the legacy platform:
