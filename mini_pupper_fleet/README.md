...
ros2 launch mini_pupper_bringup bringup.launch.py launch_twist_converter:=false multi_robot:=true robot_namespace:=robot1

# Robot 2 SSH Terminal
source ~/ros2_ws/install/setup.bash
ros2 launch mini_pupper_bringup bringup.launch.py launch_twist_converter:=false multi_robot:=true robot_namespace:=robot2

# Robot 3 SSH Terminal
source ~/ros2_ws/install/setup.bash
ros2 launch mini_pupper_bringup bringup.launch.py launch_twist_converter:=false multi_robot:=true robot_namespace:=robot3
```
